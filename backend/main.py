...
raw_origins = os.getenv(
    "ALLOWED_ORIGINS",
    "http://localhost:3000,https://trishnapaswan.vercel.app"
)
...
if "https://trishnapaswan.vercel.app" not in allowed_origins:
    allowed_origins.append("https://trishnapaswan.vercel.app")
